...
public abstract class System<T1, T2, T3> : ISystem where T1 : Component where T2 : Component where T3 : Component
{
	...
	public void AddEntity(Entity entity) => componentSets.Add((entity.GetComponent<T1>(), entity.GetComponent<T2>(), entity.GetComponent<T3>()));
	...
	protected virtual void OnInitialize(IEnumerable<(T1, T2, T3)> componentSets) { }
	...
	protected virtual void OnUpdate(float deltaTime, IEnumerable<(T1, T2, T3)> componentSets) { }
	...
	protected virtual void OnDraw(IEnumerable<(T1, T2, T3)> componentSets) { }
	...
	protected virtual void OnMouseMove(Vector2 position, Vector2 delta, IEnumerable<(T1, T2, T3)> componentSets) { }
	...
	protected virtual void OnKeyDown(Keys key, IEnumerable<(T1, T2, T3)> componentSets) { }
	...
	protected virtual void OnKeyUp(Keys key, IEnumerable<(T1, T2, T3)> componentSets) { }
