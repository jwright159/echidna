...
{
	public static void Bind(this Mesh mesh)
	{
		if (mesh.VertexArrayObject == 0) throw new ArgumentNullException(nameof(mesh));
		GL.BindVertexArray(mesh.VertexArrayObject);
	}
	public static void Bind(this Shader shader)
	{
	...
	public static void SetVector4(this Shader shader, string name, Vector4 data) => GL.Uniform4(shader.GetUniformLocation(name), data);
	public static void SetVector4(this Shader shader, string name, Color data) => GL.Uniform4(shader.GetUniformLocation(name), data);
}